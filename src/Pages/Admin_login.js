            ...
            <div style={{textAlign:'center',marginTop:'100px'}}>
                ...
                <div style={{alignItems:'center',marginTop:'0px',marginBottom:'80px'}}>
                    <form onSubmit={admin_check}>
                        <input type="password" onChange={(e)=>setDF(e.target.value)} style={{width:'30%'}} className="emailField" placeholder="Type here"></input>,
                        <br></br>
                        <button style={{width:'10%'}} onClick={admin_check} className="submitButton">{prog ? <CircularProgress size={20} style={{color:'white',marginTop:'5px'}} />: "Login"}</button>
                    </form>
                </div>
            </div>
